...
function playSelectSound() {
  try {
    ...
    console.warn("Error playing select sound:", e);
  }
}
...
function playBatCrack() {
  try {
    ...
    console.warn("Error playing bat crack sound:", e);
  }
}
...
function playCrowdCheer(duration, maxVolume) {
  try {
    ...
    console.warn("Error playing crowd cheer sound:", e);
  }
}
...
function playGloveCatch() {
  try {
    ...
    console.warn("Error playing glove catch sound:", e);
  }
}
...
function playTagSound() {
  try {
    ...
    console.warn("Error playing tag sound:", e);
  }
}
